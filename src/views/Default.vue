<template>
  <div class="calculator">
    ...
    <button style="grid-area: rooting" @click="calculateRooting">√</button>
    <button style="grid-area: square" @click="calculateSquare">x²</button>
    <button style="grid-area: reciprocal" @click="calculateReciprocal">¹/x</button>

    <button style="grid-area: ac" @click="clear">AC</button>
    <button style="grid-area: backspace" @click="calculateBackspace">
      <img src="../assets/backspace.png" alt="delete">
    </button>
...
.calculator {
  ...
  grid-template-areas: "result result result result"
                      "percent rooting square reciprocal"
